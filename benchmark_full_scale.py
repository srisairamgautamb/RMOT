"""
RMOT Full Scale Benchmark Suite
Tests all modules against the Engineering Specification targets with FULL scale parameters.
"""
import time
import numpy as np
import warnings
...
def benchmark_module4_rmot():
    ...
    # Use a simplified model price to ensure calibration is feasible for benchmark
    # Or use the same formula as before
...
def benchmark_module5_frtb():
    ...
    # Create portfolio
    n_positions = 100  # FULL SCALE
    positions = []
    for i in range(n_positions):
        strike = 80 + (i % 40)  # Spread strikes
...
def run_all_benchmarks():
    ...
    print("\n" + "#"*60)
    print("# RMOT SYSTEM BENCHMARK SUITE - FULL SCALE")
